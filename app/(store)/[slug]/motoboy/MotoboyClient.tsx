...
import { acceptRide, finishRide } from '@/app/actions/driver'
import { updateMotoboyLocation } from '@/app/actions/tracker'
...
export default function MotoboyClient({
  ...
  const handleAccept = (id: string) => {
    ...
    startTransition(async () => {
      // 🔒 storeId + slug garantem isolamento de tenant e revalidação correta
      await acceptRide(id, storeId, slug)
